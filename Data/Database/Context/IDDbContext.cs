...
namespace Meeting_App.Data.Database.Context
{
    public partial class IDDbContext : DbContext
    {
        ...
        public virtual DbSet<CadreWiseReport> CadreWiseReport { get; set; }
        ...
        public virtual DbSet<CounterCard> CounterCard { get; set; }
        public virtual DbSet<CounterDashboardView> CounterDashboardView { get; set; }
        public virtual DbSet<Customers> Customers { get; set; }
        public virtual DbSet<DepartmentWiseReport> DepartmentWiseReport { get; set; }
        ...
        public virtual DbSet<ExternalParticepant> ExternalParticepant { get; set; }
        public virtual DbSet<ExternalParticepantWithSchedule> ExternalParticepantWithSchedule { get; set; }
        public virtual DbSet<ExternalParticipantWiseReport> ExternalParticipantWiseReport { get; set; }
        public virtual DbSet<Files> Files { get; set; }
        public virtual DbSet<Folders> Folders { get; set; }
        public virtual DbSet<GetExternalParticipantView> GetExternalParticipantView { get; set; }
        public virtual DbSet<GetTrainingListView> GetTrainingListView { get; set; }
        ...
        public virtual DbSet<PraticipantAttendance> PraticipantAttendance { get; set; }
        ...
        public virtual DbSet<ScheduleTrainingwithProfileView> ScheduleTrainingwithProfileView { get; set; }
        public virtual DbSet<Tehsils> Tehsils { get; set; }
        public virtual DbSet<TotalTrainingMonthChartView> TotalTrainingMonthChartView { get; set; }
        public virtual DbSet<TraineeWiseReport> TraineeWiseReport { get; set; }
        public virtual DbSet<TrainerWiseReport> TrainerWiseReport { get; set; }
        public virtual DbSet<TrainingCategoryWiseReport> TrainingCategoryWiseReport { get; set; }
        public virtual DbSet<TrainingLevelWiseReport> TrainingLevelWiseReport { get; set; }
        public virtual DbSet<TrainingParticipant> TrainingParticipant { get; set; }
        public virtual DbSet<TrainingTypeReport> TrainingTypeReport { get; set; }
        public virtual DbSet<TrainingTypeWiseReport> TrainingTypeWiseReport { get; set; }
        public virtual DbSet<TrainingWiseReport> TrainingWiseReport { get; set; }
        public virtual DbSet<TrainingWiseReportWithDate> TrainingWiseReportWithDate { get; set; }
        public virtual DbSet<VenueWiseReport> VenueWiseReport { get; set; }
        ...
        public virtual DbSet<tbl_SupportedBy> tbl_SupportedBy { get; set; }
        ...
        public virtual DbSet<tbl_TrainingCadre> tbl_TrainingCadre { get; set; }
        public virtual DbSet<tbl_TrainingCategory> tbl_TrainingCategory { get; set; }
        public virtual DbSet<tbl_TrainingLevel> tbl_TrainingLevel { get; set; }
        public virtual DbSet<tbl_TrainingOrganizedBy> tbl_TrainingOrganizedBy { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CadreWiseReport>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("CadreWiseReport");
            ...
            modelBuilder.Entity<CounterCard>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("CounterCard");
            });

            modelBuilder.Entity<CounterDashboardView>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("CounterDashboardView");
            });

            modelBuilder.Entity<DepartmentWiseReport>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("DepartmentWiseReport");
            });
            ...
            modelBuilder.Entity<EventCalender>(entity =>
            {
                ...
                entity.Property(e => e.VenueNotAvailable).HasDefaultValueSql("((0))");

                entity.Property(e => e.Virtual).HasDefaultValueSql("((0))");
            ...
            modelBuilder.Entity<ExternalParticepant>(entity =>
            {
                entity.Property(e => e.CNIC).HasMaxLength(500);
                ...
                entity.Property(e => e.JobTittle).HasMaxLength(500);
                ...
                entity.Property(e => e.Tehsil).HasMaxLength(500);

                entity.Property(e => e.UpdatedBy).HasMaxLength(500);

                entity.Property(e => e.UpdationDate).HasColumnType("datetime");

                entity.Property(e => e.WorkingPlace).HasMaxLength(500);
            });

            modelBuilder.Entity<ExternalParticepantWithSchedule>(entity =>
            {
                entity.Property(e => e.AttendanceStatus).HasMaxLength(50);

                entity.Property(e => e.CreatedDate).HasColumnType("datetime");

                entity.Property(e => e.ObtainMarksAfterTraining).HasMaxLength(50);

                entity.Property(e => e.ObtainMarksBeforeTrainig).HasMaxLength(50);

                entity.Property(e => e.ParticipantStatus).HasMaxLength(50);

                entity.Property(e => e.ParticipantTrainingStatus).HasMaxLength(50);
            });

            modelBuilder.Entity<ExternalParticipantWiseReport>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ExternalParticipantWiseReport");
                ...
                entity.Property(e => e.WorkingHealthFacility).HasMaxLength(500);
            });
            ...
            modelBuilder.Entity<GetExternalParticipantView>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("GetExternalParticipantView");
            ...
            modelBuilder.Entity<GetTrainingListView>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("GetTrainingListView");
            ...
            modelBuilder.Entity<PraticipantAttendance>(entity =>
            {
                entity.Property(e => e.EndDate).HasColumnType("datetime");
            ...
            modelBuilder.Entity<ProfileView>(entity =>
            {
                ...
                entity.Property(e => e.DesignationVacancy).IsRequired();
                ...
                entity.Property(e => e.JDesignationVacancy).IsRequired();
                ...
                entity.Property(e => e.SubStatusName).HasMaxLength(2050);
                ...
                entity.Property(e => e.WDesignationVacancy).IsRequired();
            ...
            modelBuilder.Entity<ScheduleTraining>(entity =>
            {
                ...
                entity.Property(e => e.IsPrevious).HasDefaultValueSql("((0))");

                entity.Property(e => e.OrganizedBy).HasMaxLength(500);

                entity.Property(e => e.RecordStatus).HasDefaultValueSql("((0))");

                entity.Property(e => e.StartDate).HasColumnType("datetime");

                entity.Property(e => e.SupportedBy).HasMaxLength(500);
            ...
            modelBuilder.Entity<ScheduleTrainingwithProfileView>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ScheduleTrainingwithProfileView");

                entity.Property(e => e.AttendanceStatus).HasMaxLength(500);
                ...
                entity.Property(e => e.ParticipantStatus).HasMaxLength(500);
                ...
                entity.Property(e => e.WorkingPlaceAtTraining).HasMaxLength(500);
            });
            ...
            modelBuilder.Entity<TotalTrainingMonthChartView>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("TotalTrainingMonthChartView");

                entity.Property(e => e.MonthName).HasMaxLength(30);

                entity.Property(e => e.Total_Training).HasColumnName("Total Training");
            });

            modelBuilder.Entity<TraineeWiseReport>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("TraineeWiseReport");
            ...
            modelBuilder.Entity<TrainerWiseReport>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("TrainerWiseReport");
            ...
            modelBuilder.Entity<TrainingCategoryWiseReport>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("TrainingCategoryWiseReport");

                entity.Property(e => e.TraingCategore).HasMaxLength(500);
            });

            modelBuilder.Entity<TrainingLevelWiseReport>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("TrainingLevelWiseReport");
            });
            ...
            modelBuilder.Entity<TrainingParticipant>(entity =>
            {
                ...
                entity.Property(e => e.HFatthetimetaining).HasMaxLength(500);
            ...
            modelBuilder.Entity<TrainingTypeReport>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("TrainingTypeReport");

                entity.Property(e => e.TrainingType).HasMaxLength(500);
            });

            modelBuilder.Entity<TrainingTypeWiseReport>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("TrainingTypeWiseReport");

                entity.Property(e => e.TrainingType).HasMaxLength(500);
            });

            modelBuilder.Entity<TrainingWiseReport>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("TrainingWiseReport");
            ...
            modelBuilder.Entity<TrainingWiseReportWithDate>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("TrainingWiseReportWithDate");
            ...
            modelBuilder.Entity<VenueWiseReport>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VenueWiseReport");
            });
            ...
            modelBuilder.Entity<tbl_DocumentType>(entity =>
            {
                entity.Property(e => e.CreatedBy).HasMaxLength(500);
            ...
            modelBuilder.Entity<tbl_SupportedBy>(entity =>
            {
                entity.Property(e => e.CreatedBy).HasMaxLength(500);
            ...
            modelBuilder.Entity<tbl_TrainingCadre>(entity =>
            {
                entity.Property(e => e.CreatedBy).HasMaxLength(50);
            ...
            modelBuilder.Entity<tbl_TrainingLevel>(entity =>
            {
                entity.Property(e => e.CreatedBy).HasMaxLength(500);
            ...
            modelBuilder.Entity<tbl_TrainingOrganizedBy>(entity =>
            {
                entity.Property(e => e.CreatedBy).HasMaxLength(500);
